...
using Game.Base.Html.CodeFormatter;
using Game.Base.Infrastructure;

namespace Game.Base.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                ...
                // format the URL tags: [url=http://www.gameCommerce.com]my site[/url]
                // becomes: <a href="http://www.gameCommerce.com">my site</a>
                text = regexUrl1.Replace(text, $"<a href=\"$1\" rel=\"nofollow\"{(newWindow ? " target=_blank" : "")}>$2</a>");

                // format the URL tags: [url]http://www.gameCommerce.com[/url]
                // becomes: <a href="http://www.gameCommerce.com">http://www.gameCommerce.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]http://www.gameCommerce.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="http://www.gameCommerce.com/Content/Images/Image.jpg">
