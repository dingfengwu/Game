...
namespace Game.Base
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual string GetThisPageUrl(bool includeQueryString, bool? useSsl = null, bool lowercaseUrl = false)
        {
            ...
            var url = GetSiteHost(useSsl.Value).TrimEnd('/');
        ...
        public virtual string GetSiteLocation(bool? useSsl = null)
        {
            ...
            //get store host
            var host = GetSiteHost(useSsl.Value).TrimEnd('/');
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false)
        {
            ...
            if (!success)
            {
                throw new GameException("gameCommerce needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContextAccessor.HttpContext.Items["game.IsPOSTBeingDone"] == null)
                    return false;

                return Convert.ToBoolean(_httpContextAccessor.HttpContext.Items["game.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContextAccessor.HttpContext.Items["game.IsPOSTBeingDone"] = value;
            }
        }
