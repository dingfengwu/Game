...
namespace Game.Services.Helpers
{
    ...
    public partial class UserAgentHelper : IUserAgentHelper
    {
        ...
        /// Ctor
        /// </summary>
        /// <param name="gameConfig">Config</param>
        /// <param name="httpContextAccessor">HTTP context accessor</param>
        public UserAgentHelper(GameConfig gameConfig, IHttpContextAccessor httpContextAccessor)
        {
        ...
        protected virtual BrowscapXmlHelper GetBrowscapXmlHelper()
        {
            ...
            //no database created
            if (string.IsNullOrEmpty(_gameConfig.UserAgentStringsPath))
                return null;
            ...
            lock (_locker)
            {
                ...
                var userAgentStringsPath = CommonHelper.MapPath(_gameConfig.UserAgentStringsPath);
                var crawlerOnlyUserAgentStringsPath = !string.IsNullOrEmpty(_gameConfig.CrawlerOnlyUserAgentStringsPath)
                    ? CommonHelper.MapPath(_gameConfig.CrawlerOnlyUserAgentStringsPath)
                    : string.Empty;
        ...
        public virtual bool IsSearchEngine()
        {
            ...
            //more info: https://www.gamecommerce.com/boards/t/17711/unhandled-exception-request-is-not-available-in-this-context.aspx
            try
            {
