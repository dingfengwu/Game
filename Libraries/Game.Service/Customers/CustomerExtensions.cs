...
using Game.Services.Customers.Cache;
...
namespace Game.Services.Customers
{
    ...
    public static class CustomerExtensions
    {
        ...
        public static int[] GetCustomerRoleIds(this Customer customer, bool showHidden = false)
        {
            ...
            var customerRolesIds = customer.CustomerCustomerRoleMapping
               .Where(cr => showHidden || cr.CustomerRole.Active)
               .Select(cr => cr.CustomerRole.Id)
               .ToArray();
        ...
        public static bool PasswordIsExpired(this Customer customer)
        {
            ...
            if (!customer.CustomerCustomerRoleMapping.Any(role => role.CustomerRole.Active && role.CustomerRole.EnablePasswordLifetime))
                return false;
