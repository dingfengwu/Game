...
namespace Game.Services.Security
{
    ...
    public class EncryptionService : IEncryptionService
    {
        ...
        public virtual string CreateHash(byte[] data, string hashAlgorithm)
        {
            ...
            var algorithm = CreateHashAlgorithm(hashAlgorithm);
            if (algorithm == null)
        ...
        private HashAlgorithm CreateHashAlgorithm(string hashAlgorithm)
        {
