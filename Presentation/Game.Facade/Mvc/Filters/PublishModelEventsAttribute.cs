    ...
    public class PublishModelEventsAttribute : TypeFilterAttribute
    {
        ...
        private class PublishModelEventsFilter : IActionFilter
        {
            ...
            public void OnActionExecuting(ActionExecutingContext context)
            {
                ...
                foreach (var model in context.ActionArguments.Values.OfType<BaseGameModel>())
                {
                    //we publish the ModelReceived event for all models as the BaseGameModel, 
                    //so you need to implement IConsumer<ModelReceived<BaseGameModel>> interface to handle this event
            ...
            public void OnActionExecuted(ActionExecutedContext context)
            {
                ...
                {
                    if (controller.ViewData.Model is BaseGameModel model)
                    {
                    ...
                    if (controller.ViewData.Model is IEnumerable<BaseGameModel> modelCollection)
                    {
