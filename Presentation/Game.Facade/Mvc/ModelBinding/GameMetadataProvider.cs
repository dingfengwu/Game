...
namespace Game.Facade.Mvc.ModelBinding
{
    ...
    /// </summary>
    public class GameMetadataProvider : IDisplayMetadataProvider
    {
        /// <summary>
        ...
        public void CreateDisplayMetadata(DisplayMetadataProviderContext context)
        {
            ...
            foreach (var additionalValue in additionalValues)
            {
                if (context.DisplayMetadata.AdditionalValues.ContainsKey(additionalValue.Name))
                    throw new GameException("There is already an attribute with the name '{0}' on this model", additionalValue.Name);
