...
using Game.Facade.Extensions;

namespace Game.Facade.TagHelpers.Admin
{
    /// <summary>
    /// game-tabs tag helper
    /// </summary>
    [HtmlTargetElement("game-tabs", Attributes = IdAttributeName)]
    public class GameTabsTagHelper : TagHelper
    {
        ...
        public GameTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //create context item
            var tabContext = new List<GameTabContextItem>();
            context.Items.Add(typeof(GameTabsTagHelper), tabContext);
    ...
    /// "game-tab tag helper
    /// </summary>
    [HtmlTargetElement("game-tab", ParentTag = "game-tabs", Attributes = NameAttributeName)]
    public class GameTabTagHelper : TagHelper
    {
        ...
        /// </summary>
        /// <param name="htmlHelper">HTML helper</param>
        public GameTabTagHelper(IHtmlHelper htmlHelper)
        {
            _htmlHelper = htmlHelper;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<GameTabContextItem>)context.Items[typeof(GameTabsTagHelper)];
            tabContext.Add(new GameTabContextItem()
            {
    ...
    /// Tab context item
    /// </summary>
    public class GameTabContextItem
    {
        /// <summary>
        /// Title
        /// </summary>
