...
{
    /// <summary>
    /// game-override-store-checkbox tag helper
    /// </summary>
    [HtmlTargetElement("game-override-store-checkbox", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class GameOverrideStoreCheckboxHelper : TagHelper
    {
        ...
        public GameOverrideStoreCheckboxHelper(IHtmlHelper htmlHelper)
        {
