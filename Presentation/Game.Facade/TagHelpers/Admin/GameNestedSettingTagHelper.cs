...
{
    /// <summary>
    /// game-nested-setting tag helper
    /// </summary>
    [HtmlTargetElement("game-nested-setting", Attributes = ForAttributeName)]
    public class GameNestedSettingTagHelper : TagHelper
    {
        ...
        public GameNestedSettingTagHelper(IHtmlGenerator generator, AdminAreaSettings adminAreaSettings)
        {
            Generator = generator;
