...
{
    /// <summary>
    /// game-action-confirmation tag helper
    /// </summary>
    [HtmlTargetElement("game-action-confirmation", Attributes = ButtonIdAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class GameActionConfirmationTagHelper : TagHelper
    {
        ...
        public GameActionConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
