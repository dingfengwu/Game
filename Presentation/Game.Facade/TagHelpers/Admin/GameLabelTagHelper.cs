...
{
    /// <summary>
    /// game-label tag helper
    /// </summary>
    [HtmlTargetElement("game-label", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class GameLabelTagHelper : TagHelper
    {
        ...
        public GameLabelTagHelper(IHtmlGenerator generator, IWorkContext workContext, ILocalizationService localizationService)
        {
            Generator = generator;
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (tagBuilder != null)
            {
                ...
                //add hint
                if (For.Metadata.AdditionalValues.TryGetValue("GameResourceDisplayNameAttribute", out object value))
                {
                    var resourceDisplayName = value as GameResourceDisplayNameAttribute;
