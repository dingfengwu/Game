...
{
    /// <summary>
    /// game-textarea tag helper
    /// </summary>
    [HtmlTargetElement("game-textarea", Attributes = ForAttributeName)]
    public class GameTextAreaTagHelper : TextAreaTagHelper
    {
        ...
        public GameTextAreaTagHelper(IHtmlGenerator generator) : base(generator)
        {
        }
