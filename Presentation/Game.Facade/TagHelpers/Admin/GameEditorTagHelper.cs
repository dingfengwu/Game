...
{
    /// <summary>
    /// game-editor tag helper
    /// </summary>
    [HtmlTargetElement("game-editor", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class GameEditorTagHelper : TagHelper
    {
        ...
        public GameEditorTagHelper(IHtmlHelper htmlHelper)
        {
