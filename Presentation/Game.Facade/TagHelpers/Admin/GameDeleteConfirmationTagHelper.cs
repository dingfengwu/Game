...
{
    /// <summary>
    /// game-delete-confirmation tag helper
    /// </summary>
    [HtmlTargetElement("game-delete-confirmation", Attributes = ModelIdAttributeName + "," + ButtonIdAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class GameDeleteConfirmationTagHelper : TagHelper
    {
        ...
        public GameDeleteConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
