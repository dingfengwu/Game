...
{
    /// <summary>
    /// game-select tag helper
    /// </summary>
    [HtmlTargetElement("game-select", TagStructure = TagStructure.WithoutEndTag)]
    public class GameSelectTagHelper : TagHelper
    {
        ...
        public GameSelectTagHelper(IHtmlHelper htmlHelper)
        {
