...
{
    /// <summary>
    /// game-date-picker tag helper
    /// </summary>
    [HtmlTargetElement("game-date-picker", 
        Attributes = DayNameAttributeName + "," + MonthNameAttributeName + "," + YearNameAttributeName, 
        TagStructure = TagStructure.WithoutEndTag)]
    public class GameDatePickerTagHelper : TagHelper
    {
        ...
        public GameDatePickerTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
