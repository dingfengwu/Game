...
{
    /// <summary>
    /// game-bb-code-editor tag helper
    /// </summary>
    [HtmlTargetElement("game-bb-code-editor", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class GameBBCodeEditorTagHelper : TagHelper
    {
        ...
        public GameBBCodeEditorTagHelper(IWebHelper webHelper)
        {
