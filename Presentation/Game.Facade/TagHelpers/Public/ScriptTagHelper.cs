...
namespace Game.Facade.TagHelpers.Public
{
    ...
    public class ScriptTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (_httpContextAccessor.HttpContext.Items["game.IgnoreScriptTagLocation"] != null &&
                Convert.ToBoolean(_httpContextAccessor.HttpContext.Items["game.IgnoreScriptTagLocation"]))
                return;
