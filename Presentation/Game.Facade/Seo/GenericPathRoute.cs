...
namespace Game.Facade.Seo
{
    ...
    public class GenericPathRoute : LocalizedRoute
    {
        ...
        protected RouteValueDictionary GetRouteValues(RouteContext context)
        {
            ...
            if (this.SeoFriendlyUrlsForLanguagesEnabled && path.IsLocalizedUrl(context.HttpContext.Request.PathBase, false, out _))
        ...
        public override Task RouteAsync(RouteContext context)
        {
            ...
            if (!urlRecord.IsActive)
            {
                ...
                context.HttpContext.Items["game.RedirectFromGenericPathRoute"] = true;
